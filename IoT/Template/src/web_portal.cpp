...
"<span class='badge'>Node: Base Template</span>"
"</div>"
...
static void handleRoot() {
  ...
  html += "<input type='text' id='pairing_code' name='pairing_code' value='" + String(config.pairingCode) + "' placeholder='e.g. SH-7788' required maxlength='64'>";
  html += "</div>";
